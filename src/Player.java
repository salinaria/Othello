 ...
 * @author Ali Ansari
 * @version 1.0
 * This class does work for player
 */
public class Player {
    private Table table;
    private int num;
     ...
     *
     * @param table The table player play game on it
    ...
    /**
     * This function show us a cell of map available or not
     *
    ...
    /**
     * This function show us which cells of table can reset
     *
     * @param row    The row of cell
     * @param column The column of cell
    ...
    /**
     * This function show us which cells on the table available
     *
     * @return An array
     */
    ...
    /**
     * This function choose the cell of table
     *
